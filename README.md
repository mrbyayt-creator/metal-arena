...
## Junkyard map surface fix

This version makes the Junkyard OBJ road surface driveable with a lightweight height field and keeps only raised junk/walls as blockers.
