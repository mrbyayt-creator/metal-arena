...
- Menu music now attempts to start immediately on page load and still falls back to first user interaction if the browser blocks autoplay.
- Low flat cover blocks were raised to about 1.5 car height; large normal blocks were not intentionally changed.
- Rocket proximity hit detection was slightly expanded for player and bot rockets so rockets do not stick near cars/corners.
